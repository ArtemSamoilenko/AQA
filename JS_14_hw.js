...
12. Доповніть код нижче, так щоб в консоль повертався результат множення усіх чисел 
у підмасивах arr. Використайте для цього вкладені цикли for.
...
//variant1 
////////////////////////////////////////////////////
/* перегляньте ще раз, тут неправильно реалізували умову. Ви перевірили, що значення ціни 
товару не знаходиться між 999 та 1901 включно.*/
...
const modifiedWord = word.replace(/[аеёийоуэюяАЕЁИЙОУЭЮЯ]/g,'');
